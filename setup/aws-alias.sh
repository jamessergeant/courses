...
alias aws-ssh-t2-micro='aws-get-t2-micro && aws-ip && export instanceUrl=$(aws ec2 describe-instances --instance-ids $instanceId --query "Reservations[0].Instances[0].PublicDnsName" --output text) && ssh -i /home/james/.ssh/aws-key-fast-ai.pem ubuntu@$instanceUrl'
alias aws-ssh-t2-xlarge='aws-get-t2-xlarge && aws-ip && export instanceUrl=$(aws ec2 describe-instances --instance-ids $instanceId --query "Reservations[0].Instances[0].PublicDnsName" --output text) && ssh -i /home/james/.ssh/aws-key-fast-ai.pem ubuntu@$instanceUrl'
alias aws-ssh-p2='aws-get-p2 && aws-ip && export instanceUrl=$(aws ec2 describe-instances --instance-ids $instanceId --query "Reservations[0].Instances[0].PublicDnsName" --output text) && ssh -i /home/james/.ssh/aws-key-fast-ai.pem ubuntu@$instanceUrl'
